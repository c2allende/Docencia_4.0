/**
 * SCRIPT DE MANTENIMIENTO: Sincronización masiva de progreso desnormalizado.
 * Fecha: 2026-05-03
 * Objetivo: Asegurar que el campo 'progress' en la raíz de cada usuario coincida con su progreso real en subcolecciones.
 * Uso: Ejecutar en consola del navegador por un administrador.
 */
...
export async function syncAllUsersProgress() {
    ...
    for (const userDoc of usersSnap.docs) {
        ...
        const progress = {
            modulo1: userData.progress?.modulo1 || 0,
            modulo2: userData.progress?.modulo2 || 0,
            modulo3: userData.progress?.modulo3 || 0
        };
