...
Resumen
El módulo 1 ofrece una base sólida para comprender qué es un LLM, diferenciándolo claramente de los buscadores tradicionales y de los bots o apps que lo utilizan. Presenta usos estratégicos por área de contenido, mostrando cómo estas tecnologías pueden apoyar la generación de problemas, análisis de textos, adaptación de niveles de lectura y redacción de PEI. Finalmente, introduce el marco ético legal (FERPA y normativas del DEPR), los riesgos de sesgos y dependencia tecnológica, y el rol del docente como “human in the loop” que, valida, corrige y decide sobre todo lo que la IA genera.
...
1.	La Teoría Sociocultural de Vygotsky: Los LLM pueden actuar como un "andamiaje" (scaffolding) que les permite trabajar en una Zona de Desarrollo Próximo superior, liberando tiempo y energía de tareas mecánicas para invertir en decisiones pedagógicas profundas. 
...
![Guia de uso responsable de LLM][LLM_M1_Intro_guia_uso_responsable_LLM_imagen.png]

 Pregunta reflexiva para iniciar 
 	Antes de profundizar en los contenidos, reflexionen por un momento: 
"¿Qué tarea de mi gestión docente me toma más tiempo cada semana? ¿Podría un recurso como un LLM o una aplicación basada en LLM ayudarme a hacerla mejor o más rápido, sin sacrificar calidad o creatividad pedagógica?" 
No hay respuesta "correcta"; la intención es que vean de inmediato la pertinencia práctica de lo que van a aprender. 
